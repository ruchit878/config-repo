...
| 3 | Click **Add file → Create new file**.<br>• **Filename**: `user-service.properties`<br>• Add:  
```properties
message=Hello from Config Server!
```
Scroll down → **Commit new file**. | File appears in the repo |
